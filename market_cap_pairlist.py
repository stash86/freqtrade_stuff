# Taken from https://github.com/AlexBabescu/freqtrade_stuff
# All credits goes to Alex for this fine work
# Example of how to run it
# python market_cap_pairlist.py -n 127 --stake_currency BUSD --blacklist user_data/blacklist-binance.json
